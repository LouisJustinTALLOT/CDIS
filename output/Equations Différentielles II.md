...
$\delta$ sont des paramètres positifs.
...
3.  On considère la fonction $$
    ...
    la dérivée de $H$ le long des solutions dans
    $\mathbb{R}_{> 0}\times \mathbb{R}_{> 0}$. En déduire que toute
    solution initialisée dans $\mathbb{R}_{> 0}\times \mathbb{R}_{> 0}$
    est définie sur $\mathbb{R}$ et reste dans
    $\mathbb{R}_{> 0}\times \mathbb{R}_{> 0}$. Qu'en concluez vous sur
    leur comportement ? On pourra l'illustrer en représentant les
